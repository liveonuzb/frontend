...
export const APP_MODE_THEMES = {
  [APP_MODES.FOCUS]: {
    ...
    assets: {
      ...
      background: "/focus/onboarding/curious.png",
      curious: "/focus/onboarding/curious.png",
      notFound: "/focus/onboarding/curious.png",
      ...
      waterWidget: {
        background: "/focus/water-widget/background.webp",
        icon: "/focus/water-widget/icon.webp",
        indicator: "/focus/water-widget/indicator.webp",
      },
      moodFaces: {
        bad: "/focus/onboarding/male-1.png",
        tired: "/focus/onboarding/male-2.png",
        neutral: "/focus/onboarding/male-3.png",
        good: "/focus/onboarding/male-4.png",
        amazing: "/focus/onboarding/male-5.png",
      },
    },
    heroGradient: "linear-gradient(145deg,#8fa3b8 0%,#546e87 52%,#2c3e52 100%)",
  ...
  [APP_MODES.ZEN]: {
    ...
    assets: {
      ...
      background: "/zen/onboarding/curious.png",
      curious: "/zen/onboarding/curious.png",
      notFound: "/zen/onboarding/curious.png",
      onboardingBase: "/zen/onboarding",
      onboardingImageExtension: "png",
      friendsHero: "/zen/friends/hero.png",
      nutritionPlanHero: "/zen/meals/lunch.webp",
      waterWidget: {
        background: "/zen/water-widget/background.webp",
        icon: "/zen/water-widget/icon.webp",
        indicator: "/zen/water-widget/indicator.webp",
      },
      moodFaces: {
        bad: "/zen/mood/male/bad.webp",
        tired: "/zen/mood/male/tired.webp",
        neutral: "/zen/mood/male/neutral.webp",
        good: "/zen/mood/male/good.webp",
        amazing: "/zen/mood/male/amazing.webp",
      },
    },
    heroGradient: "linear-gradient(145deg,#9ad4c0 0%,#4aa88a 52%,#1e6655 100%)",
  ...
  [APP_MODES.MADAGASCAR]: {
    ...
    assets: {
      ...
      waterWidget: {
        background: "/madagascar/water-widget/background.webp",
        icon: "/madagascar/water-widget/icon.webp",
        indicator: "/madagascar/water-widget/indicator.webp",
      },
      moodFaces: {
        bad: "/madagascar/mood/male/bad.webp",
        tired: "/madagascar/mood/male/tired.webp",
        neutral: "/madagascar/mood/male/neutral.webp",
        good: "/madagascar/mood/male/good.webp",
        amazing: "/madagascar/mood/male/amazing.webp",
      },
    },
    heroGradient: "linear-gradient(145deg,#fb8a4c 0%,#df5238 52%,#9f2c29 100%)",
