...
const STEP = "preferred-ingredients";
const I18N_KEY = "onboarding.nutritionSteps.preferredIngredients";
const OPTIONS_KEY = "ingredients";
const FIELD = "preferredIngredientIds";
const LEGACY_FIELD = null;
const CUSTOM_FIELD = "customPreferredIngredients";
const NEXT_PATH = "/user/onboarding/disliked-ingredients";
const OPPOSITE_FIELD = "dislikedIngredientIds";
const OPPOSITE_CUSTOM_FIELD = "customDislikedIngredients";
