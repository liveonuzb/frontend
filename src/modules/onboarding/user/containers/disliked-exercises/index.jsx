...
const STEP = "disliked-exercises";
const I18N_KEY = "onboarding.workoutSteps.dislikedExercises";
const OPTIONS_KEY = "exercises";
const FIELD = "dislikedExerciseIds";
const LEGACY_FIELD = null;
const CUSTOM_FIELD = "customDislikedExercises";
const NEXT_PATH = "/user/onboarding/meal-frequency";
const OPPOSITE_FIELD = "preferredExerciseIds";
const OPPOSITE_CUSTOM_FIELD = "customPreferredExercises";
