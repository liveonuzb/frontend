...
const FIELD = "dislikedIngredientIds";
const LEGACY_FIELD = null;
const CUSTOM_FIELD = "customDislikedIngredients";
const NEXT_PATH = "/user/onboarding/health-constraints";
const OPPOSITE_FIELD = "preferredIngredientIds";
const OPPOSITE_CUSTOM_FIELD = "customPreferredIngredients";
const CONFLICT_I18N_KEY = "onboarding.nutritionSteps.ingredients.conflict";
...
const getOptionBadgeKey = (option) => {
  ...
  return "onboarding.chipSelect.avoidBadge";
};
