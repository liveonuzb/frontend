...
const STEP = "preferred-cuisines";
const I18N_KEY = "onboarding.nutritionSteps.preferredCuisines";
const OPTIONS_KEY = "cuisines";
const FIELD = "preferredCuisineIds";
const LEGACY_FIELD = null;
const CUSTOM_FIELD = "customPreferredCuisines";
const NEXT_PATH = "/user/onboarding/disliked-foods";
