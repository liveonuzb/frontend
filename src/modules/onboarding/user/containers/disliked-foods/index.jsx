...
const STEP = "disliked-foods";
const I18N_KEY = "onboarding.nutritionSteps.dislikedFoods";
const OPTIONS_KEY = "foods";
const FIELD = "dislikedFoodIds";
const LEGACY_FIELD = null;
const CUSTOM_FIELD = "customDislikedFoods";
const NEXT_PATH = "/user/onboarding/preferred-ingredients";
