...
const STEP = "allergies";
const I18N_KEY = "onboarding.nutritionSteps.allergies";
const OPTIONS_KEY = "allergies";
const FIELD = "allergyIds";
const LEGACY_FIELD = "allergyIngredientIds";
const CUSTOM_FIELD = "customAllergies";
const NEXT_PATH = "/user/onboarding/diet-requirements";
...
const getOptionBadgeKey = (option) => {
  ...
  if (OPTIONS_KEY === "allergies") {
    return option?.isAllergic
      ? "onboarding.chipSelect.allergicBadge"
      : "onboarding.chipSelect.commonBadge";
  }
...
const Index = () => {
  ...
  const handleExplicitNone = React.useCallback(() => {
    setFields({
      [FIELD]: [],
      [LEGACY_FIELD]: [],
      [CUSTOM_FIELD]: [],
    ...
    navigate(NEXT_PATH);
  }, [completedSteps, navigate, setFields]);
          ...
          {isLoading ? (
            ...
            <>
              <OnboardingSelectCard
                ...
                description={t(`${I18N_KEY}.noneDescription`)}
                icon={XIcon}
                onClick={handleExplicitNone}
                title={t(`${I18N_KEY}.noneAction`)}
                tone={tone}
              />
              <CatalogOptionList
                options={cardOptions}
