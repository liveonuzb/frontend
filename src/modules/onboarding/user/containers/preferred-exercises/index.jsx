...
const STEP = "preferred-exercises";
const I18N_KEY = "onboarding.workoutSteps.preferredExercises";
const OPTIONS_KEY = "exercises";
const FIELD = "preferredExerciseIds";
const LEGACY_FIELD = null;
const CUSTOM_FIELD = "customPreferredExercises";
const NEXT_PATH = "/user/onboarding/disliked-exercises";
const OPPOSITE_FIELD = "dislikedExerciseIds";
const OPPOSITE_CUSTOM_FIELD = "customDislikedExercises";
const CONFLICT_I18N_KEY = "onboarding.workoutSteps.exercises.conflict";
