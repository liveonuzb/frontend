...
const getSafetyTargetOption = (value) =>
  find(SAFETY_TARGET_OPTIONS, (option) => option.value === value) ??
  ...
  const handleCreateSafetyRule = React.useCallback(async () => {
    ...
    try {
      ...
      await createSafetyRuleMutation.mutateAsync({
        url: "/admin/workout-safety-rules",
        attributes: {
          healthConstraintId: toNumber(safetyForm.healthConstraintId),
          [targetField]: toNumber(safetyForm.targetId),
        ...
        <CardContent className="space-y-4">
          <div className="grid gap-3 lg:grid-cols-[1fr_160px_1fr_160px]">
            ...
            >
              ...
              <SelectContent>
                {map(safetyConstraints, (constraint) => (
            ...
            >
              ...
              <SelectContent>
                {map(SAFETY_TARGET_OPTIONS, (option) => (
            ...
            >
              ...
              <SelectContent>
                {map(selectedSafetyTargetItems, (item) => (
