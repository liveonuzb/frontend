            ...
            <DrawerBody>
              <Form {...form}>
                <form id="health-constraint-form" className="flex flex-col gap-4" onSubmit={form.handleSubmit(onSubmit)}>
                  ...
                  <FormField control={form.control} name="type" render={({ field }) => <FormItem><FormLabel>Turi</FormLabel><FormControl><OptionDrawerPicker value={field.value} onValueChange={field.onChange} options={TYPE_OPTIONS} title="Constraint turi" placeholder="Tanlang" /></FormControl><FormMessage /></FormItem>} />
                  <FormField control={form.control} name="genderScope" render={({ field }) => <FormItem><FormLabel>Jins bo'yicha ko'rinish</FormLabel><FormControl><OptionDrawerPicker value={field.value} onValueChange={field.onChange} options={GENDER_SCOPE_OPTIONS} title="Jins bo'yicha ko'rinish" placeholder="Tanlang" /></FormControl><FormMessage /></FormItem>} />
                </form>
              </Form>
            </DrawerBody>
            <DrawerFooter>
