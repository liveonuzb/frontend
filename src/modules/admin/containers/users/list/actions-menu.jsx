...
const UserActionsMenu = ({
  ...
  <DropdownMenu>
    ...
    <DropdownMenuContent align="end" className="w-56">
      ...
      <DropdownMenuItem
        disabled={
          isUserActionPending || !canManageSupport || !canManageUser(user)
        }
        onClick={() => onEdit(user)}
      >
      ...
      <DropdownMenuItem
        disabled={
          isUserActionPending || !canManageGrowth || !get(user, "premium.id")
        }
      ...
      <DropdownMenuItem
        disabled={
          isUserActionPending ||
          !canManageGrowth ||
          get(user, "premium.status") !== "active"
        }
      ...
      <DropdownMenuItem
        disabled={isUserActionPending || !canBlockUsers || !canManageUser(user)}
      ...
      >
        ...
        {get(user, "status") === "banned" ? "Blokdan chiqarish" : "Bloklash"}
      </DropdownMenuItem>
      <DropdownMenuItem
        variant="destructive"
        disabled={
          isUserActionPending || !canDeleteUsers || !canManageUser(user)
        }
