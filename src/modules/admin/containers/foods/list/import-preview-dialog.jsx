    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-h-[86vh] max-w-3xl overflow-hidden">
        <DialogHeader>
          ...
          <DialogDescription>
            {get(preview, "totalRows", 0)} ta qator tekshirildi.
          </DialogDescription>
        </DialogHeader>
            ...
            {lodashMap(groups, (group) => (
              <div key={group.key} className="rounded-lg border p-3">
                ...
                <div className="space-y-1.5">
                  {lodashMap(group.examples, (issue) => (
                    <div
                      key={issue.id}
                      className="grid gap-1 rounded-md bg-muted/40 px-2 py-1.5 text-xs sm:grid-cols-[84px_1fr]"
                    >
...
export default FoodImportPreviewDialog;
