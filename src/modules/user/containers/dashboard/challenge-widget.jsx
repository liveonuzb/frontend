...
export default function ChallengeWidget({
  ...
  const handleOpenChallenge = React.useCallback(
    (challengeId) => {
      ...
      navigate(
        challengeId ? `/user/challenges/${challengeId}` : "/user/challenges",
      );
    },
        ...
        {currentChallenge ? (
          ...
          >
            ...
            <div className="space-y-2">
              ...
              <Progress
                ...
                className="h-2.5 bg-[rgb(var(--accent-rgb)/0.15)]"
              />
            </div>
          ...
          <div className="mt-4 flex flex-1 flex-col rounded-[22px] border border-dashed bg-background/85 p-4">
            <p className="text-sm font-medium">
              Hali faol challenge topilmadi.
            </p>
            <p className="mt-1 text-xs text-muted-foreground">
              Challenge&apos;ga qo&apos;shilib, do&apos;stlaringiz bilan
              progressni solishtiring.
            </p>
            <Button
              type="button"
              variant="outline"
