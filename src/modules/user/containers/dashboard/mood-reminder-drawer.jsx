    ...
    >
      <DrawerContent className="data-[vaul-drawer-direction=bottom]:md:max-w-sm" data-mood-reminder-drawer="true">
        ...
        <DrawerBody className="mood-widget">
          <div className="flex min-h-[13.5rem] flex-col items-center justify-center">
            <AnimatePresence mode="wait">
              <motion.div
                key={previewMoodClass}
                className={cn("h-44 w-1/2", previewMoodClass)}
                initial={{ opacity: 0, scale: 0.82, y: 18, rotate: -3 }}
                animate={{ opacity: 1, scale: 1, y: 0, rotate: 0 }}
                exit={{ opacity: 0, scale: 0.88, y: -14, rotate: 3 }}
                transition={{
                  type: "spring",
                  stiffness: 260,
                  damping: 20,
