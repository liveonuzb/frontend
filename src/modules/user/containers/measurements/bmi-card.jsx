...
export const BmiCard = ({ bmi, onOpenModal, heightCm, currentW }) => {
  ...
  return (
    ...
    >
      ...
      {meta && (
        <div
          className="absolute -top-10 -right-10 size-40 rounded-full blur-3xl opacity-60 pointer-events-none"
          style={{
