...
const variantClassName = {
  ...
  image:
    "relative flex min-h-[84px] w-full flex-col items-start gap-1.5 rounded-2xl border bg-background/90 px-3 py-2.5 text-left shadow-sm backdrop-blur transition hover:border-primary/30 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary/50 md:min-h-[104px] md:gap-2 md:px-3.5",
  compact:
...
const imageClassName = {
  ...
  image: "size-9 rounded-xl md:size-12",
...
export const OnboardingOption = ({
  ...
  >
    ...
    <span className="min-w-0 flex-1">
      ...
      {description ? (
        <span
          className={descriptionClassName[variant] ?? descriptionClassName.row}
        >
          {description}
        </span>
      ) : null}
