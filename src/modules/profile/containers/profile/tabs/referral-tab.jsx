...
import {
    ...
    ArrowUpRightIcon, CrownIcon, MedalIcon, CheckIcon,
    ZapIcon, SendIcon, ChevronRightIcon
} from "lucide-react";
...
// Stat Card
// ---------------------------------------------------------------------------
function StatCard({ icon: Icon, label, value, color = "primary", className = "" }) {
    return (
        <Card className={`group hover:shadow-md transition-shadow ${className}`}>
            <CardContent className="p-4 flex items-center gap-3">
                <div className={`size-10 rounded-xl bg-${color}/10 flex items-center justify-center shrink-0 group-hover:scale-105 transition-transform`}>
