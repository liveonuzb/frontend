      ...
      <div className="relative min-h-svh overflow-x-hidden bg-[#fff7ed] text-slate-950 dark:bg-[#070503] dark:text-white">
        ...
        <section className="relative z-10 mx-auto flex min-h-svh w-full max-w-5xl flex-col overflow-hidden bg-[#fff8ec] dark:bg-slate-950">
          ...
          <AuthBrandHeader
            ...
            modeTheme={modeTheme}
          />
          <main className="relative z-10 flex min-h-0 flex-1 items-center justify-center overflow-y-auto px-5 py-8 sm:px-7 sm:py-10">
            <div className="mx-auto flex w-full max-w-[430px] flex-col items-center gap-10">
...
function AuthWelcomeCopy({ copy }) {
  return (
    <div className="mx-auto max-w-[22rem] text-center">
      ...
      <p className="mx-auto mt-2 max-w-[18.5rem] text-sm font-medium leading-6 text-slate-700 dark:text-white/72">
